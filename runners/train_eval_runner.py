...
if __name__ == '__main__':
    ...
    train_df = pd.read_pickle(os.path.join(args.output_folder, "train_features.pkl")).head(500)
    test_df = pd.read_pickle(os.path.join(args.output_folder, "test_features.pkl")).head(500)
